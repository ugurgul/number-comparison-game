...
public class GameManager : MonoBehaviour
{
    ...
    public void OyunaBasla()
    {
        ...
        Debug.Log("oyunbasladi");
    }

    public void KacinciOyun(){
    ...
    public void ButonDegeriniBelirle(string butonAdi)
    {
        ...
        if(butonDegeri==buyukDeger)
        {
            ...
            StartCoroutine(trueFalseManager.DogruIconGosterRoutine(true));
        ...
        {
            StartCoroutine(trueFalseManager.DogruIconGosterRoutine(false));
